  ...
  <div class="page animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content">
      <div class="page-brand-info">
        <div class="brand">
          <a href="<?php echo base_url(); ?>"><img class="brand-img" width="50px" src="<?php echo site_url(); ?>assets/assets/images/logo.png" alt="...">
          <h2 class="brand-text font-size-30">PT INDONESIA COMNETS PLUS</h2></a>
        </div>
      ...
      <div class="page-register-main">
        <div class="brand visible-xs">
          <img class="brand-img" width="50px" src="<?php echo site_url(); ?>assets/assets/images/logo.png" alt="...">
          <h3 class="brand-text font-size-30">PT INDONESIA COMNETS PLUS</h3>
        </div>
        ...
        <footer class="page-copyright">
          ...
          <p>© 2022. PT INDONESIA COMNETS PLUS.</p>
