                ...
                <div class=" tab-pane animation-fade active" id="category-1" role="tabpanel">
                  ...
                  aria-multiselectable="true" role="tablist">
                    ...
                    <div class="panel">
                      ...
                      Apa Itu Sistem Rumah sakit ?
                      </a>
                      </div>
                      <div class="panel-collapse collapse in" id="answer-1" aria-labelledby="question-1"
                      role="tabpanel">
                        <div class="panel-body">
                          Sistem Informasi Geografis Gangguan Jaringan adalah Website Yang Menampilkan data Gangguan dan Pengaduan Gangguan Jaringan Provinsi Aceh Dengan Menggunakan Peta.
                        </div>
                      </div>
                    </div>
                    <!-- End Question 1 -->
                    ...
                    <div class="panel">
                      ...
                      role="tabpanel">
                        <div class="panel-body">
                          Website ini Memberikan Informasi Gangguan Jaringan Icon+ di Provinsi Aceh. Terdapat Fitur Pengaduan Yang Memungkinkan User Icon+ Melakukan Pengaduan Terhadap Kondisi Jaringan yang sedang User pakai.
                        </div>
                      </div>
                    </div>
                    <!-- End Question 2 -->
                    ...
                    <div class="panel">
                      <div class="panel-heading" id="question-3" role="tab">
                        ...
                        Bagaimana jika ingin Menghubungi PT Indonesia Comnets Plus ?
                      </a>
                      </div>
                      <div class="panel-collapse collapse" id="answer-3" aria-labelledby="question-3"
                      role="tabpanel">
                        <div class="panel-body">
                          Dapat Mendatangi PT Icon+ Di Jl. Nyak Adam Kamil III No.2, Neusu Jaya, Kec. Baiturrahman, Kota Banda Aceh
                          Telp. , Fax.  -  Atau Dapat Mengirim Email Ke
                          Email: [at]
                        </div>
                      </div>
                    </div>
                ...
                <div class="tab-pane animation-fade" id="category-2" role="tabpanel">
                  ...
                  aria-multiselectable="true" role="tablist">
                    ...
                    <div class="panel">
                      ...
                      role="tabpanel">
                        <div class="panel-body">
                          Pengaduan Adalah Pemberitahuan disertai permintaan oleh pihak yang berkepentingan kepada Icon+ berwenang untuk menindak lanjuti Permasalahan Yang di Hadapai
                          Dalam Website ini Dapat Dilakukan Pengaduan Gangguan Jaringan Terhadap Jaringan Icon+ di Provinsi Aceh.
                        </div>
                      </div>
                    </div>
                    <!-- End Question 5 -->
