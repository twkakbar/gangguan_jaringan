...
<?php echo $this->load->view('common/menu', '', TRUE);?>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Tambah POP</h1>
            ...
            <form   action="jalan/proses_tambah_jalan" method="post" enctype="multipart/form-data" class="fv-form fv-form-bootstrap">
              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                    <h3 class="panel-title">POP</h3>
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Kode POP
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="kode_pop" placeholder="Kode pop" required=""  >
                  </div>
                  </div>
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Kanal/Port POP
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="no_pop" placeholder="No pop" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Nama POP
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="nama_jalan" placeholder="Nama POP" required="" >
                    </div>
                  </div>
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-3 col-sm-9">
                      <input type="text" class="form-control" name="ke" placeholder="Latitude" required="" >
                    </div>
                    ...
                    <div class=" col-lg-4 col-sm-9">
                      <input type="text" class="form-control" name="dari" placeholder="Longitude" required="" >
                    </div>
                  </div>
