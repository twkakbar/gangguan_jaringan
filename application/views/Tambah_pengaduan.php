...
<?php echo $this->load->view('common/menu', '', TRUE);?>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Pelaporan Gangguan Jaringan Lintas Provinsi</h1>
            ...
            <form  action="pengaduan/proses_tambah_pengaduan" method="post" enctype="multipart/form-data"   class="fv-form fv-form-bootstrap">
              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Keterangan Lokasi Lainnya
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class="col-lg-9 col-sm-9 ">
                      ...
                      <!--   <div>
                        ...
                        <div>
                          <div class="radio-custom radio-primary">
                            <input type="radio" id="inputUltraAwesome" name="kondisi" value="3" data-fv-field="porto_is" checked>
