...
<?php echo $this->load->view('common/menu', '', TRUE);?>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Data POP</h1>
            ...
            <tbody>
              <?php
               ...
               ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $data_jalan->kode_pop; ?></td>
                  <td><?php echo $data_jalan->nama_jalan; ?></td>
                  <td><?php echo $data_jalan->nama_kabupaten; ?></td>
                  <td><?php echo $data_jalan->nama_kecamatan; ?></td>

                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."detail_jalan?id=".$data_jalan->kode_pop."'>
                  <button type='button' class='btn btn-success'>Detail</button></a>
                    </td>";
                  ?>
                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."Jalan/proses_hapus_jalan?id=$data_jalan->kode_pop' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
