              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Kode pop
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data_jalan->kode_pop?>" readonly name="kode_pop" placeholder="Kode pop" required=""  >

                  </div>
                  </div>
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">No pop
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data_jalan->no_pop?>" readonly name="no_pop" placeholder="No pop" required="" >
                    </div>
                  </div>
                
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">pop Jalan
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="nama_jalan" value="<?php echo $data_jalan->nama_jalan?>" readonly  placeholder="pop Jalan" required="" >
                    </div>
                  </div>
                  
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Latitude
                      <span class="required">*</span>
                    </label>
                    ...
                    <label class="col-lg-2 col-sm-3 control-label">Longitude*
                      <span class="required"></span>
                    </label>
                ...
                <div class="col-lg-6 form-horizontal">
                    <h3 class="panel-title">Dokumen POP</h3>
                ...
                <div class="form-group form-material col-lg-12 text-right padding-top-m">
                  <?php echo"
                  <center>
                  <a href='". site_url()."edit_jalan?id=$data_jalan->kode_pop' onclick=\"return confirm('Apakah Anda Yakin Untuk Mengubah Data Jalan ?')
                      \" title='Hapus'><button type='button' class='btn btn-warning'>Edit POP</button></a>
                  <center>
                    ";?>
                </div>
              </div>
