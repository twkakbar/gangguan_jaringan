                ...
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" readonly value="<?php echo $data_jalan->kode_pop?>"  name="kode_pop" placeholder="Kode pop" required=""  >
                  </div>
                  </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data_jalan->no_pop?>"  name="no_pop" placeholder="No pop" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="nama_jalan" value="<?php echo $data_jalan->nama_jalan?>"   placeholder="pop Jalan" required="" >
                    </div>
                  </div>
