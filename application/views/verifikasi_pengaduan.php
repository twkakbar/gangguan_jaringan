              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                    ...
                    <div class="form-group form-material ">
                      ...
                      <small class="help-block" data-fv-validator="notEmpty" data-fv-for="company" data-fv-result="INVALID" style="">Plilh Kecamatan</small></div>
                    </div>
                  <div class="form-group form-material ">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class="form-group form-material ">
                      <label class="col-lg-3 col-sm-3 control-label">POP
                        <span class="required">*</span>
                      </label>
                      <div class="col-lg-9 col-sm-9">
                        <select class="form-control select2-hidden-accessible" required name="kode_pop" data-plugin="select2"  data-allow-clear="true" tabindex="-1" aria-hidden="true">
                          <option value=""></option>
                          <?php

                             foreach($jalan as $jalan){
                              if($data_jalan->kode_pop!=$jalan->kode_pop){
                           ?>
                          <option value="<?php echo $jalan->kode_pop; ?>"><?php echo $jalan->nama_jalan; ?></option>
                          <?php } } ?>
                        </select>
                      <small class="help-block" data-fv-validator="notEmpty" data-fv-for="company" data-fv-result="INVALID" style="">Plilh POP</small></div>
                    </div>
                </div>
                <div class="col-lg-6 form-horizontal">
                  <div class="form-group form-material ">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="luas_jalan"  value="<?php echo $pengaduan->luas_jalan?>"  placeholder="Keterangan Gangguan Lainnya">
                    </div>
                  </div>
                  <div class="form-group form-material ">
