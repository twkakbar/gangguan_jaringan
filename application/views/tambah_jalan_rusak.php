...
<?php echo $this->load->view('common/menu', '', TRUE);?>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Tambah Gangguan Jaringan</h1>
            ...
            <form   action="jalan_rusak/proses_tambah_jalan_rusak" method="post" enctype="multipart/form-data" class="fv-form fv-form-bootstrap">
              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                    <h3 class="panel-title">Tambah Gangguan Jaringan</h3>
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class="col-lg-9 col-sm-9">
                      <select class="form-control select2-hidden-accessible" name="kode_pop" data-plugin="select2" required data-placeholder="Pilih" data-allow-clear="true" tabindex="-1" aria-hidden="true" id="jalan">
                        <option value="">Pilih</option>
                        <?php
                           $i=0;
                    ...
                    <small class="help-block" data-fv-validator="notEmpty" data-fv-for="company" data-fv-result="INVALID" style="">Pilih POP</small></div>
                  </div>
                ...
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="luas_jalan" placeholder="Keterangan Gangguan Lainnya">
                    </div>
                  </div>
                  <div class="form-group form-material ">
