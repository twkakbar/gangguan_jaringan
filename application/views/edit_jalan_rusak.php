              ...
              <div class="row row-lg">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class="col-lg-9 col-sm-9">
                      <select class="form-control select2-hidden-accessible" required  name="kode_pop" data-plugin="select2"  data-allow-clear="true" tabindex="-1" aria-hidden="true">
                        <option value="<?php echo $data_jalan_rusak->kode_pop?>"><?php echo $data_jalan_rusak->nama_jalan?></option>
                        <?php
                ...
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="luas_jalan" value="<?php echo $data_jalan_rusak->luas_jalan?>"  placeholder="Keterangan Gangguan Lainnya">
                    </div>
                  </div>
                  <div class="form-group form-material ">
