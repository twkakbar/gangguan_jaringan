              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class="col-lg-9 col-sm-9">
                      <select class="form-control select2-hidden-accessible"  name="kode_pop" data-plugin="select2"  data-allow-clear="true" tabindex="-1" aria-hidden="true">
                ...
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    <label class="col-lg-3 col-sm-3 control-label">Keterangan Lainnya
                      <span class="required">*</span>
                    </label>
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="luas_jalan" value="<?php echo $data_jalan_rusak->luas_jalan?>" readonly placeholder="pop Jalan Rusak">
                    </div>
                  </div>
                  <div class="form-group form-material ">
                ...
                echo"
                <center>
                <a href='". site_url()."Jalan_rusak/perbaikan_jalan_rusak?id=$data_jalan_rusak->kode_jalan_rusak' onclick=\"return confirm('Apakah Anda Yakin Untuk Merubah Status Gangguan Jaringan Menjadi Sudah Di Perbaiki ?')
